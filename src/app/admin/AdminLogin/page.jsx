...
const AdminLogin = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-[#74CDFF26] py-8 px-4">
            <form
                onSubmit={handleAdminLogin}
                className=" p-8 rounded-xl  max-w-sm w-full sm:max-w-md md:max-w-lg lg:max-w-xl flex flex-col justify-center items-center gap-4">
