...
export default function AddTitleCategory() {
    ...
    return (
        <div className="max-w-md mx-auto bg-white shadow-md rounded-lg p-6 mt-10 md:flex md:flex-col  ">
            ...
            <form onSubmit={handleSubmit} className="md:flex flex-col h-[40vh] md:justify-between">
                ...
                {permissions.addTitleCategory ? (
                    <button
                        type="submit"
                        className="w-full bg-[#F10505] text-white py-2 rounded-md hover:bg-red-700 transition"
                        disabled={loading}
                    >
