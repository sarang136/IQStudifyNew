...
export default function AddCategory() {
    ...
    return (
        <div className="max-w-lg mx-auto mt-10 p-6  shadow-md rounded-lg">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col justify-between h-[50vh]">
                ...
                {permissions.addCategory ? (<button
                    type="submit"
                    className="w-full bg-[#F10505] text-white py-2 rounded hover:bg-red-700 transition"
                >
                    Add Category
                </button>)
