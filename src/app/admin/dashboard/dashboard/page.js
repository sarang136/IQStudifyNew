...
const DashboardStats = () => {
  ...
  const boxStyle =
    "flex items-center gap-2 bg-white rounded-md shadow-sm px-6 py-4 md:w-[20vw] w-full";
  ...
  return (
    <div className="p-6 bg-gray-100 min-h-screen">
      ...
      <div className="flex flex-wrap gap-6 justify-between md:justify-between">
        {/* Total */}
        ...
        <div className={boxStyle}>
          ...
          <div className={textWrap}>
            ...
            <span className="text-gray-500 text-sm">Approved MCQs</span>
          </div>
        </div>
        ...
        <div className={boxStyle}>
          ...
          <div className={textWrap}>
            ...
            <span className="text-gray-500 text-sm">Pending MCQs</span>
          </div>
        </div>
        ...
        <div className={boxStyle}>
          ...
          <div className={textWrap}>
            ...
            <span className="text-gray-500 text-sm">Draft MCQs</span>
          </div>
        </div>
      </div>
    </div>
