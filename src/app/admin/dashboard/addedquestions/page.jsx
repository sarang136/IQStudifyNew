      ...
      <div className="flex justify-between items-center mb-6">
        ...
        {questions?.length === 0 ? (
          ...
          <div className="hidden lg:flex gap-3">
            <button
              onClick={() => router.push("/admin/dashboard/addquestion")}
              className="px-4 py-2 bg-[#F10505] text-white rounded-lg hover:bg-red-700 transition-colors duration-200 flex items-center gap-2"
            >
              <PlusIcon className="w-4 h-4" />
              Add Question
            </button>
      ...
      {showModal && selectedQuestion && (
        <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50">
          <motion.div
            ...
            className="bg-white dark:bg-gray-800 text-black dark:text-white rounded-lg p-6 h-[90vh] w-[90%] md:w-[400px] shadow-2xl relative overflow-y-scroll"
          >
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div
                  className="prose prose-sm max-w-none p-2 bg-gray-100 rounded prose-img:max-w-[200px] prose-img:h-auto"
                  dangerouslySetInnerHTML={{
                    __html: DOMPurify.sanitize(selectedQuestion.questionText)
                  }}
                />
              </div>
              ...
              {selectedQuestion.questionType === "direct" && (
                <div>
                  ...
                  <div
                    className="prose prose-sm max-w-none p-2 bg-gray-100 rounded prose-img:max-w-[200px] prose-img:h-auto"
                    dangerouslySetInnerHTML={{
                      __html: DOMPurify.sanitize(selectedQuestion.directAnswer)
                    }}
                  />
                </div>
              )}
                  ...
                  <div key={i} className="p-2 bg-gray-100 rounded mb-2">
                    {i === selectedQuestion.correctOptionIndex ? (
                      <span className="font-bold text-green-600">✓
                        <div
                          className="prose prose-sm max-w-none prose-img:max-w-[200px] prose-img:h-auto"
                          dangerouslySetInnerHTML={{
              ...
              <div>
                ...
                <div className="p-2 bg-gray-100 rounded">
                  <div
                    className="prose prose-sm max-w-none prose-img:max-w-[200px] prose-img:h-auto"
                    dangerouslySetInnerHTML={{
                      __html: DOMPurify.sanitize(selectedQuestion.answerExplanation)
                    }}
                  />
                </div>
              </div>
